...
export default function MowixFooter() {
  return (
    <footer data-elementor-type="footer" data-elementor-id="1002" className="elementor elementor-1002 elementor-location-footer">
      <div className="elementor-element elementor-element-b1d03ae e-con-full e-flex e-con e-parent" data-id="b1d03ae">
        <div className="elementor-element elementor-element-e7cc02c e-flex e-con-boxed e-con e-child" data-id="e7cc02c">
            ...
            <div className="elementor-element elementor-element-2cbdb90 e-con-full e-flex e-con e-child" data-id="2cbdb90">
              ...
              <div className="elementor-element elementor-element-129e8c6 e-con-full e-flex e-con e-child" data-id="129e8c6">
                ...
                <div className="elementor-element elementor-element-a09fa5e e-con-full e-flex e-con e-child" data-id="a09fa5e">
                  <div className="elementor-element elementor-element-2fee20e elementor-widget elementor-widget-heading" data-id="2fee20e" data-widget_type="heading.default">
                    <h4 className="elementor-heading-title elementor-size-default">Social Media</h4>
                  </div>
                  <div className="elementor-element elementor-element-689e5a4 elementor-shape-circle e-grid-align-left e-grid-align-mobile-center elementor-grid-0 elementor-widget elementor-widget-social-icons" data-id="689e5a4" data-widget_type="social-icons.default">
                    <div className="elementor-social-icons-wrapper elementor-grid" role="list">
                      <span className="elementor-grid-item" role="listitem">
                        <a className="elementor-icon elementor-social-icon elementor-social-icon-instagram elementor-repeater-item-25138f9" target="_blank">
                      ...
                      {" "}
                      <span className="elementor-grid-item" role="listitem">
                        <a className="elementor-icon elementor-social-icon elementor-social-icon-facebook elementor-repeater-item-7c761b5" target="_blank">
                      ...
                      {" "}
                      <span className="elementor-grid-item" role="listitem">
                        <a className="elementor-icon elementor-social-icon elementor-social-icon-twitter elementor-repeater-item-8041c66" target="_blank">
                      ...
                      {" "}
                      <span className="elementor-grid-item" role="listitem">
                        <a className="elementor-icon elementor-social-icon elementor-social-icon-youtube elementor-repeater-item-6ee361d" target="_blank">
